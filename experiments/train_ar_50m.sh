...
#SBATCH --job-name=ar_50m
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=24
#SBATCH --mem-per-cpu=15G
#SBATCH --time=72:00:00
#SBATCH --output=output/logs/ar_50m_%j.out
#SBATCH --error=output/logs/ar_50m_%j.err
...
TRAIN_DATA_PATH=utils/datapaths/train_c4_50m.txt
...
# Data Count: 50M tokens, 50 epochs
