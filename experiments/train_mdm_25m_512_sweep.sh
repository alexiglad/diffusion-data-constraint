...
#SBATCH --job-name=mdm_25m_512
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=24
#SBATCH --mem-per-cpu=15G
#SBATCH --time=72:00:00
#SBATCH --output=output/logs/mdm_25m_512_%A_%a.out
#SBATCH --error=output/logs/mdm_25m_512_%A_%a.err
#SBATCH --array=0-2
...
VARIANT=mdm_25m_512_${SIZE}_500ep
