...
#SBATCH --job-name=mdm_25m_256
#SBATCH --nodes=1
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-gpu=24
#SBATCH --mem-per-cpu=15G
#SBATCH --time=72:00:00
#SBATCH --output=output/logs/mdm_25m_256_%j.out
#SBATCH --error=output/logs/mdm_25m_256_%j.err
...
VARIANT=mdm_25m_256_425M_500ep
...
# Data Count: 25M tokens, 500 epochs
